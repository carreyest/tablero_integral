<?php
//Include Common Files @1-0E751101
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "IncidentesDetalleNSSLOs.php");
...
//Class_Initialize Event @26-878CDCCF
    function clsGridmc_info_incidentes($RelativePath, & $Parent)
    {
        ...
        $this->Panel1->AddComponent("Cumple_DISP_SOPORTE", $this->Cumple_DISP_SOPORTE);
...
//DataSource Variables @26-853BB17A
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @26-3ECFECF5
...
//SetOrder Method @26-EFD832B0
    function SetOrder($SorterName, $SorterDirection)
    {
        ...
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            ...
            "Sorter3" => array("Cumple_DISP_SOPORTE", "")));
    }
//End SetOrder Method
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "IncidentesDetalleNSSLOs.html";
$BlockToParse = "main";
...
//Include events file @1-FD6A69BF
include_once("./IncidentesDetalleNSSLOs_events.php");

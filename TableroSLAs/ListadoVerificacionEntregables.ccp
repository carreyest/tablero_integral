...
<SQLParameter id="136" dataType="Integer" defaultValue="1" parameterSource="busqproveedor" parameterType="URL" variable="busqproveedor"/>
		...
		<Record id="44" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="GenList" actionPage="ListadoVerificacionEntregables" errorSummator="Error" wizardFormMethod="post" PathID="GenList" connection="cnDisenio" customInsertType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="ISQLParameters" customInsert="INSERT INTO entregables_periodicos_smda4(entregado, comentarios, anio_corte, mes_corte, id_entregable, id_proveedor) 
...
OR c.proveedor = p.descripcion)" dataSource="entregables_periodicos_smda4">
			<Components>
				<Button id="46" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Generar" wizardCaption="Agregar" PathID="GenListButton_Generar" operation="Insert">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<ListBox id="82" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Integer" returnValueType="Number" name="MesGenCorte" fieldSource="MesReporte" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Mes Reporte" caption="Mes Reporte" required="False" unique="False" connection="cnDisenio" wizardEmptyCaption="Seleccionar Valor" PathID="GenListMesGenCorte" dataSource="mc_c_mes" boundColumn="IdMes" textColumn="Mes" defaultValue="date('m')"><Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
					<SQLParameters/>
				...
				<ListBox id="83" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Integer" returnValueType="Number" name="AnioGenCorte" fieldSource="anioreporte" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Anioreporte" caption="Anioreporte" required="False" unique="False" connection="cnDisenio" wizardEmptyCaption="Seleccionar Valor" PathID="GenListAnioGenCorte" dataSource="mc_c_anio" boundColumn="Ano" textColumn="Ano" defaultValue="2015">
					<Components/>
					<Events/>
					<TableParameters>
						<TableParameter id="84" conditionType="Parameter" useIsNull="False" dataType="Integer" field="Ano" logicOperator="And" parameterSource="2013" parameterType="Expression" searchConditionType="GreaterThan"/>
					</TableParameters>
					<SPParameters/>
					<SQLParameters/>
					<JoinTables>
						<JoinTable id="85" posHeight="88" posLeft="10" posTop="10" posWidth="95" tableName="mc_c_anio"/>
					</JoinTables>
					<JoinLinks/>
					<Fields>
					...
					<PKFields>
						<PKField id="87" dataType="Integer" fieldName="Ano" tableName="mc_c_anio"/>
					</PKFields>
					<Attributes/>
					<Features/>
				</ListBox>
				<ListBox id="124" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="Genproveedor" wizardEmptyCaption="Seleccionar Valor" PathID="GenListGenproveedor" connection="cnDisenio" dataSource="mc_c_proveedor" boundColumn="id_proveedor" textColumn="nombre">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
					<SQLParameters/>
					<JoinTables>
						<JoinTable id="125" posHeight="180" posLeft="10" posTop="10" posWidth="158" schemaName="dbo" tableName="mc_c_proveedor"/>
					</JoinTables>
					<JoinLinks/>
					<Fields>
						<Field id="126" fieldName="id_proveedor" tableName="mc_c_proveedor"/>
						<Field id="127" fieldName="nombre" tableName="mc_c_proveedor"/>
					</Fields>
					<PKFields/>
					<Attributes/>
					<Features/>
			...
			<ISPParameters/>
			<ISQLParameters>
				<SQLParameter id="91" variable="MesGenCorte" parameterType="Control" dataType="Integer" parameterSource="MesGenCorte" defaultValue="1"/>
				<SQLParameter id="92" variable="AnioGenCorte" parameterType="Control" defaultValue="2015" dataType="Integer" parameterSource="AnioGenCorte"/>
				<SQLParameter id="128" variable="Genproveedor" parameterType="Control" dataType="Integer" parameterSource="Genproveedor" defaultValue="0"/>
			</ISQLParameters>
			<IFormElements>

...
<Events/>
<TableParameters>
<TableParameter id="13" conditionType="Parameter" useIsNull="False" dataType="Integer" field="id" logicOperator="And" orderNumber="1" parameterSource="id" parameterType="URL" searchConditionType="Equal"/>
</TableParameters>
<SPParameters/>
<SQLParameters/>
<JoinTables>
<JoinTable id="14" posHeight="180" posLeft="10" posTop="10" posWidth="160" tableName="mc_calificacion_capc"/>
</JoinTables>
<JoinLinks/>
<Fields>
<Field id="15" fieldName="*"/>
</Fields>
<PKFields>
<PKField id="16" dataType="Integer" fieldName="id" tableName="mc_calificacion_capc"/>
</PKFields>
<ISPParameters/>
<ISQLParameters/>
<IFormElements/>

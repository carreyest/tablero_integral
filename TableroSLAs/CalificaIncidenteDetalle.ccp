...
WHERE mi.Id_incidente = '{Id_incidente}' " errorSummator="Error" allowCancel="False" recordDeleteConfirmation="False" buttonsType="button" wizardRecordKey="Id" encryptPasswordField="False" wizardUseInterVariables="False" pkIsAutoincrement="True" wizardCaption="Add/Edit Mc Info Incidentes " wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="False" recordDirection="Horizontal" templatePageRecord="C:\Program Files (x86)\CodeChargeStudio5//Templates//Record//Horizontal.ccp|ccsTemplate" recordAddTemplatePanel="False" PathID="mc_info_incidentes2">
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="306" dataType="Text" designDefaultValue="INC000003432416" parameterSource="Id_incidente" parameterType="URL" variable="Id_incidente"/>
			</SQLParameters>
			<JoinTables/>
			<JoinLinks/>
			<Fields/>
		...
		<Grid id="68" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" name="mc_detalle_incidente_avl" connection="cnDisenio" dataSource="
...
where i.id_incidente = '{Id_incidente}'" pageSizeLimit="100" pageSize="True" wizardCaption="List of Mc Detalle Incidente Avl " wizardThemeApplyTo="Page" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No records" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="True" gridTotalRecords="False" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="False" gridExtendedHTML="False" PathID="mc_detalle_incidente_avl">
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="300" dataType="Text" designDefaultValue="INC000003376478" parameterSource="Id_incidente" parameterType="URL" variable="Id_incidente"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
...
AND i.Id_incidente = '{Id_incidente}' ">
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="302" dataType="Text" parameterSource="Id_incidente" parameterType="URL" variable="Id_incidente"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks>
...
WHERE Id_incidente = '{Id_incidente}' " errorSummator="Error" allowCancel="False" recordDeleteConfirmation="False" buttonsType="button" wizardRecordKey="Id" encryptPasswordField="False" wizardUseInterVariables="False" pkIsAutoincrement="True" wizardCaption="Add/Edit Mc Info Incidentes " wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="False" recordDirection="Horizontal" templatePageRecord="C:\Program Files (x86)\CodeChargeStudio5//Templates//Record//Horizontal.ccp|ccsTemplate" recordAddTemplatePanel="False" PathID="mc_info_incidentes3">
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="305" dataType="Text" parameterSource="Id_incidente" parameterType="URL" variable="Id_incidente"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
		...
		<Record id="234" sourceType="SQL" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="mc_c_aplicacion" connection="cnDisenio" dataSource="SELECT 
...
WHERE Id_incidente = '{Id_incidente}' " errorSummator="Error" allowCancel="False" recordDeleteConfirmation="False" buttonsType="button" wizardRecordKey="id" encryptPasswordField="False" wizardUseInterVariables="True" pkIsAutoincrement="True" wizardCaption="{res:mc_c_aplicacion_RecordForm}" wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="False" recordDirection="Vertical" templatePageRecord="C:/Program Files (x86)/CodeChargeStudio5/Templates/Record/Dialog.ccp|ccsTemplate" recordAddTemplatePanel="False" PathID="mc_c_aplicacion">
			<Components>
				<Label id="237" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="descripcion" fieldSource="descripcion" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="{res:descripcion}" wizardAddNbsp="True" PathID="mc_c_aplicaciondescripcion">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="238" fieldSourceType="DBColumn" dataType="Integer" html="False" generateSpan="False" name="severidad" fieldSource="severidad" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="{res:severidad}" wizardAddNbsp="True" PathID="mc_c_aplicacionseveridad">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="274" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="lblTiempoAtencion" PathID="mc_c_aplicacionlblTiempoAtencion" fieldSource="TiempoAtencion">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
				...
				<Label id="275" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="lblTiempoSolucion" PathID="mc_c_aplicacionlblTiempoSolucion" fieldSource="TiempoSolucion">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="278" dataType="Text" designDefaultValue="INC000003156314" parameterSource="Id_incidente" parameterType="URL" variable="Id_incidente"/>
			</SQLParameters>
			<JoinTables/>
			<JoinLinks/>
			<Fields/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="CalificaIncidenteDetalle_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="CalificaIncidenteDetalle.php" forShow="True" url="CalificaIncidenteDetalle.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>

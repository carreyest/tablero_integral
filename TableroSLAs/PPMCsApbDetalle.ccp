...
" boundColumn="id_servicio" textColumn="nombre" required="True" caption="Servicio de Negocio" fieldSource="id_servicio_negocio">
				...
				<TextBox id="173" visible="Yes" fieldSourceType="DBColumn" dataType="Float" name="HorasSAT" PathID="mc_info_rs_ap_ECHorasSAT" fieldSource="HorasSAT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="PPMCsApbDetalle_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="PPMCsApbDetalle.php" forShow="True" url="PPMCsApbDetalle.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>

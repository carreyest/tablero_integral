...
//Include Common Files @1-D249CDB1
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "SLAsCapcApbDetalle2.php");
...
//Class_Initialize Event @3-F558A1F5
    function clsRecordmc_info_rs_ap_EC($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->FechaAceptacionPropuesta->Required = true;
...
//DataSource Variables @3-953026FB
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @3-E4E1D796
...
//Open Method @3-588207E2
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
        "FROM mc_info_capc_ap {SQL_Where} {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SLAsCapcApbDetalle2.html";
$BlockToParse = "main";
...
//Include events file @1-C6A7C1F2
include_once("./SLAsCapcApbDetalle2_events.php");
...
$lkSiguiente->Page = "SLAsCapcApbDetalle.php";
...
$lkAnterior->Page = "SLAsCapcApbDetalle.php";

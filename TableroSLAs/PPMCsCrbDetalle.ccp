...
" boundColumn="id_servicio" textColumn="nombre" required="True" caption="Servicio de Negocio" fieldSource="id_servicio_negocio">
				...
				<Button id="372" urlType="Relative" enableValidation="True" isDefault="False" name="btnCalcular" PathID="mc_info_rs_ap_ECbtnCalcular" operation="Cancel" returnPage="PPMCsCrbDetalle.ccp" removeParameters="URLReferencia">
					<Components/>
					<Events>
 ...
 " PathID="Panel1">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="PPMCsCrbDetalle_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="PPMCsCrbDetalle.php" forShow="True" url="PPMCsCrbDetalle.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>

...
order by sc.orden" pageSizeLimit="100" pageSize="True" wizardCaption="Niveles de Servicio" wizardThemeApplyTo="Page" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="True" gridTotalRecords="False" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="True" gridExtendedHTML="False" PathID="pnlTableroSLAsgrdTableroSLAs" wizardAllowSorting="True">
					...
					<SPParameters/>
					<SQLParameters>
						<SQLParameter id="407" dataType="Integer" defaultValue="date('m')-2" designDefaultValue="1" parameterSource="s_MesReporte" parameterType="URL" variable="sMes" old_temp_id="346"/>
						<SQLParameter id="408" dataType="Integer" defaultValue="date('Y')" designDefaultValue="2014" parameterSource="s_AnioReporte" parameterType="URL" variable="sAnio" old_temp_id="347"/>
						<SQLParameter id="409" dataType="Integer" defaultValue="0" designDefaultValue="3" parameterSource="s_id_proveedor" parameterType="URL" variable="sProveedor" old_temp_id="348"/>
						<SQLParameter id="410" dataType="Integer" defaultValue="0" designDefaultValue="1" parameterSource="sSLO" parameterType="URL" variable="sSLO" old_temp_id="349"/>
					</SQLParameters>
					<SecurityGroups/>
					<Attributes/>
					<Features/>
...
group by 	
	...
	c.agrupador" pageSizeLimit="100" pageSize="True" wizardCaption="Niveles de Servicio" wizardThemeApplyTo="Page" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="True" gridTotalRecords="False" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="True" gridExtendedHTML="False" PathID="pnlSLAsCAPCgrdSLAsCAPC" wizardAllowSorting="True">
					<Components>
						...
						<Sorter id="416" visible="True" name="Sorter_TotCAL_COD" column="TotCAL_COD" wizardCaption="Tot EST PROY" wizardSortingType="SimpleDir" wizardControl="TotEST_PROY" wizardAddNbsp="False" PathID="pnlSLAsCAPCgrdSLAsCAPCSorter_TotCAL_COD">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="417" visible="True" name="Sorter_TotDEF_FUG_AMB_PROD" column="TotDEF_FUG_AMB_PROD" wizardCaption="Tot DEF FUG AMB PROD" wizardSortingType="SimpleDir" wizardControl="TotDEF_FUG_AMB_PROD" wizardAddNbsp="False" PathID="pnlSLAsCAPCgrdSLAsCAPCSorter_TotDEF_FUG_AMB_PROD">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="418" visible="True" name="Sorter_TotTiempoAsignacion" column="TotTiempoAsignacion" wizardCaption="Tot Tiempo Asignacion" wizardSortingType="SimpleDir" wizardControl="TotTiempoAsignacion" wizardAddNbsp="False" PathID="pnlSLAsCAPCgrdSLAsCAPCSorter_TotTiempoAsignacion">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</Sorter>
						<Sorter id="419" visible="True" name="Sorter_TotTiempoSolucion" column="TotTiempoSolucion" wizardCaption="Tot Tiempo Solucion" wizardSortingType="SimpleDir" wizardControl="TotTiempoSolucion" wizardAddNbsp="False" PathID="pnlSLAsCAPCgrdSLAsCAPCSorter_TotTiempoSolucion">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						...
						<Sorter id="461" visible="True" name="Sorter_EFIC_PRES" wizardSortingType="SimpleDir" PathID="pnlSLAsCAPCgrdSLAsCAPCSorter_EFIC_PRES" wizardCaption="Eficiencia&lt;br&gt;Presupuestal" column="EFIC_PRESUP">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
					...
					<SPParameters/>
					<SQLParameters>
						<SQLParameter id="468" dataType="Integer" defaultValue="date('m')-2" designDefaultValue="6" old_temp_id="346" parameterSource="s_MesReporte" parameterType="URL" variable="sMes"/>
<SQLParameter id="469" dataType="Integer" defaultValue="date('Y')" designDefaultValue="2015" old_temp_id="347" parameterSource="s_AnioReporte" parameterType="URL" variable="sAnio"/>
<SQLParameter id="470" dataType="Integer" defaultValue="0" designDefaultValue="1" old_temp_id="348" parameterSource="s_id_proveedor" parameterType="URL" variable="sProveedor"/>
<SQLParameter id="471" dataType="Integer" defaultValue="0" designDefaultValue="0" old_temp_id="349" parameterSource="sSLO" parameterType="URL" variable="sSLO"/>
</SQLParameters>
					<SecurityGroups/>
					<Attributes/>
					<Features/>

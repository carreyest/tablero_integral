...
" boundColumn="id_servicio" textColumn="nombre" required="True" caption="Servicio de Negocio" fieldSource="id_servicio_negocio">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="SLAsCapcApbDetalle_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="SLAsCapcApbDetalle.php" forShow="True" url="SLAsCapcApbDetalle.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>

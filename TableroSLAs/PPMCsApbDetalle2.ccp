<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="{CCS_Style}" wizardThemeVersion="3.0" useDesign="False" needGeneration="0">
	<Components>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="False" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="mc_info_rs_ap_EC" connection="cnDisenio" dataSource="mc_info_rs_ap_EC" errorSummator="Error" allowCancel="False" recordDeleteConfirmation="False" buttonsType="button" wizardRecordKey="ID_PPMC" encryptPasswordField="False" wizardUseInterVariables="False" pkIsAutoincrement="True" wizardCaption="Calificar Requerimiento" wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="True" recordDirection="Vertical" recordAddTemplatePanel="False" PathID="mc_info_rs_ap_EC" activeCollection="IFormElements" activeTableType="mc_info_rs_ap_EC">
			<Components>
...
" boundColumn="id_servicio" textColumn="nombre" required="True" caption="Servicio de Negocio" fieldSource="id_servicio_negocio">
				...
				<ListBox id="51" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Text" returnValueType="Number" name="lstServContractual" wizardEmptyCaption="Seleccionar Valor" PathID="mc_info_rs_ap_EClstServContractual" connection="cnDisenio" dataSource="mc_c_ServContractual" boundColumn="Id" textColumn="Descripcion" caption="Servicio Contractual" required="True" fieldSource="id_servicio_cont">
					...
					<TableParameters>
						<TableParameter id="170" conditionType="Parameter" useIsNull="False" dataType="Text" field="Aplica" logicOperator="And" parameterSource="'CDS'" parameterType="Expression" searchConditionType="Equal"/>
					</TableParameters>
					<SPParameters/>
					<SQLParameters/>
					<JoinTables>
						<JoinTable id="169" posHeight="104" posLeft="10" posTop="10" posWidth="95" tableName="mc_c_ServContractual"/>
					</JoinTables>
					<JoinLinks/>
					<Fields>
						<Field id="171" fieldName="*"/>
					</Fields>
					<PKFields>
						<PKField id="172" dataType="Integer" fieldName="Id" tableName="mc_c_ServContractual"/>
					</PKFields>
					<Attributes/>
					<Features/>
				</ListBox>
				...
				<CheckBox id="121" visible="Yes" fieldSourceType="DBColumn" dataType="Boolean" defaultValue="Unchecked" name="formatoEvidencia" PathID="mc_info_rs_ap_ECformatoEvidencia" checkedValue="True" uncheckedValue="False" fieldSource="formatoEvidencia">
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="138" eventType="Client"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
				...
				<CheckBox id="163" visible="Yes" fieldSourceType="DBColumn" dataType="Boolean" defaultValue="Unchecked" name="SinEvidencia" PathID="mc_info_rs_ap_ECSinEvidencia" checkedValue="1" uncheckedValue="0" fieldSource="SinEvidencia">
					...
					<Events>
						<Event name="OnClick" type="Client">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="164" eventType="Client"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
				...
				<TextBox id="187" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DHoraSAT" PathID="mc_info_rs_ap_ECDHoraSAT" features="(assigned)" format="0;(0)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
						...
						<Event name="BeforeShow" type="Server">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="197"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					<Features>
						<JNumericUpDown id="188" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="1000" name="NumericUpDown1" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<TextBox id="189" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DMinSAT" PathID="mc_info_rs_ap_ECDMinSAT" features="(assigned)" format="0;(0)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
					...
					<Attributes/>
					<Features>
						<JNumericUpDown id="190" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="59" name="NumericUpDown2" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<TextBox id="191" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DSegSAT" PathID="mc_info_rs_ap_ECDSegSAT" features="(assigned)" format="0;(0)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
					...
					<Attributes/>
					<Features>
						<JNumericUpDown id="192" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="59" name="NumericUpDown3" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<Hidden id="196" fieldSourceType="DBColumn" dataType="Float" name="HorasSAT" PathID="mc_info_rs_ap_ECHorasSAT" fieldSource="HorasSAT">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Features/>
			...
			<TableParameters>
				<TableParameter id="182" conditionType="Parameter" useIsNull="False" dataType="Integer" field="Id" logicOperator="And" orderNumber="1" parameterSource="sID" parameterType="URL" searchConditionType="Equal"/>
			</TableParameters>
			<SPParameters/>
			<SQLParameters/>
			<JoinTables>
				<JoinTable id="181" posHeight="400" posLeft="10" posTop="10" posWidth="160" tableName="mc_info_rs_ap_EC"/>
			</JoinTables>
			<JoinLinks/>
			<Fields>
				<Field id="183" fieldName="*"/>
			</Fields>
			<PKFields>
				<PKField id="184" dataType="Integer" fieldName="Id" tableName="mc_info_rs_ap_EC"/>
				<PKField id="185" dataType="Text" fieldName="ID_PPMC" tableName="mc_info_rs_ap_EC"/>
			</PKFields>
			<ISPParameters/>
			<ISQLParameters>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="PPMCsApbDetalle2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="PPMCsApbDetalle2.php" forShow="True" url="PPMCsApbDetalle2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>

...
//Include Common Files @1-9078E4A1
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "PPMCsCrbDetalle2.php");
...
//Class_Initialize Event @3-AC26DF80
...
"FROM mc_c_TipoPPMC {SQL_Where} {SQL_OrderBy}";
            ...
            $this->porc_re = new clsControl(ccsHidden, "porc_re", "porc_re", ccsText, "", CCGetRequestParam("porc_re", $Method, NULL), $this);
...
//Validate Method @3-D8BEE635
    function Validate()
    {
        ...
        $Validation = ($this->porc_re->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->porc_re->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @3-12ADBE93
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->porc_re->Errors->Count());
    ...
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            ...
            if($this->PressedButton == "Button_Insert") {
                ...
                $Redirect = "PPMCsCrbDetalle2.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
                if(!CCGetEvent($this->Button_Update->CCSEvents, "OnClick", $this->Button_Update) || !$this->UpdateRow()) {
                    $Redirect = "";
                }
            } else if($this->PressedButton == "btnCalcular") {
                $Redirect = "PPMCsCrbDetalle2.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "URLReferencia"));
...
//InsertRow Method @3-6F173F0C
    function InsertRow()
    {
        ...
        $this->DataSource->porc_re->SetValue($this->porc_re->GetValue(true));
...
//Show Method @3-9AC010F3
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->porc_re->Errors->ToString());
...
//DataSource Variables @3-9752ADD2
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @3-F35D78D1
    function clsmc_info_rs_ap_ECDataSource(& $Parent)
    {
        ...
        $this->porc_re = new clsField("porc_re", ccsText, "");
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "PPMCsCrbDetalle2.html";
$BlockToParse = "main";
...
//Include events file @1-31D52362
include_once("./PPMCsCrbDetalle2_events.php");

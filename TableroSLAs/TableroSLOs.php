<?php
//Include Common Files @1-41BE94E3
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "TableroSLOs.php");
...
//Operation Method @55-7B89BE2B
    function Operation()
    {
        ...
        $Redirect = "TableroSLOs.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "TableroSLOs.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "TableroSLOs.html";
$BlockToParse = "main";
...
//Include events file @1-411C4E2A
include_once("./TableroSLOs_events.php");

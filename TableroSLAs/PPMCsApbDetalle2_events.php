...
//mc_info_rs_ap_EC_DHoraSAT_BeforeShow @187-84DB25F0
...
//Close mc_info_rs_ap_EC_DHoraSAT_BeforeShow @187-A8EA61CA
...
//Page_BeforeShow @1-AF760C38
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $PPMCsApbDetalle2; //Compatibility
//End Page_BeforeShow
...
// -------------------------
    ...
    if(count($aPPMCsAPbIds)>1){
    	...
    	if($iPos==0){
    		...
    		$lkAnterior->SetLink("PPMCsApbDetalle2.php?" . CCAddParam( CCRemoveParam( CCGetQueryString("QueryString","sID"),"ccsForm"),"sID",$aPPMCsAPbIds[$iPos-1]));
    	}
    	if($iPos < count($aPPMCsAPbIds)-1){
    		$lkSiguiente->SetValue($aPPMCsAPbValues[$iPos+1]);
    		$lkSiguiente->SetLink("PPMCsApbDetalle2.php?" . CCAddParam( CCRemoveParam( CCGetQueryString("QueryString","sID"),"ccsForm"),"sID",$aPPMCsAPbIds[$iPos+1]));
    	} else {

...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    $this->Messages = array();
    $this->Messages["anioreporte"] = "Anio Reporte";
    ...
    $this->Messages["cumple_disp_soporte"] = "Cumple Disponibilidad del Personal de Soporte";
    $this->Messages["cumple_inc_tiempoasignacion"] = "Cumple Inc Tiempo Asignacion";
    $this->Messages["cumple_inc_tiemposolucion"] = "Cumple Inc Tiempo Solucion";
    $this->Messages["descartar"] = "Descartar";
    $this->Messages["grdincidentes"] = "Grd Incidentes";
    $this->Messages["grid1"] = "Grid1";
    $this->Messages["id_incidente"] = "Id Incidente";
    $this->Messages["id_proveedor"] = "Id Proveedor";
    $this->Messages["id_servicio"] = "Id Servicio";
    $this->Messages["id_servicio_negocio"] = "Id Servicio Negocio";
    $this->Messages["incidente"] = "Incidente";
    $this->Messages["mesreporte"] = "Mes Reporte";
    $this->Messages["obs_proceso"] = "Obs Proceso";
    $this->Messages["paquete"] = "Paquete";
    $this->Messages["proveedor"] = "Proveedor";
    $this->Messages["servicionegocio"] = "Servicio de Negocio";
    $this->Messages["severidad"] = "Severidad";
    $this->IsLoaded = true;
  }

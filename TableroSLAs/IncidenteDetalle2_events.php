...
// -------------------------
	...
	{ 	
		...
		$Container->slAnterior->SetValue($miArray[$claveAnterior]);
   		...
   		$RedirectAnterior =  "IncidenteDetalle2.php?" . CCAddParam( CCRemoveParam( CCGetQueryString("QueryString","Id_incidente"),"ccsForm"),"Id_incidente",$miArray[$claveAnterior]);
	...
	else
	{
   	...
   	$RedirectSiguiente =  "IncidenteDetalle2.php?" . CCAddParam( CCRemoveParam( CCGetQueryString("QueryString","Id_incidente"),"ccsForm"),"Id_incidente",$miArray[$claveSiguiente]);
...
// -------------------------
	global $Redirec;
   	$Redirec =  "IncidenteDetalle2.php?" . CCAddParam( CCRemoveParam( CCGetQueryString("QueryString","export"),"ccsForm"),"export","1");
...
//Page_BeforeInitialize @1-D3B19D12
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $IncidenteDetalle2; //Compatibility
...
//Page_OnInitializeView @1-07A0D223
...
//Page_AfterInitialize @1-A614CBB0

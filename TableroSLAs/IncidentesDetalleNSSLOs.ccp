 ...
 &amp;nbsp;&lt;/td&gt; 
        ...
        &lt;/tr&gt;" PathID="mc_info_incidentesPanel1">
					<Components>
						...
						<Image id="142" fieldSourceType="DBColumn" dataType="Integer" html="False" generateSpan="False" name="Cumple_DISP_SOPORTE" PathID="mc_info_incidentesPanel1Cumple_DISP_SOPORTE" fieldSource="Cumple_DISP_SOPORTE" visible="Yes">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
				...
				<Sorter id="218" visible="True" name="Sorter3" wizardSortingType="SimpleDir" PathID="mc_info_incidentesSorter3" wizardCaption="Disponibilidad del&lt;br&gt;Personal de Soporte" column="Cumple_DISP_SOPORTE">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="IncidentesDetalleNSSLOs_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="IncidentesDetalleNSSLOs.php" forShow="True" url="IncidentesDetalleNSSLOs.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters>

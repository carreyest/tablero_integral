<?php
//Include Common Files @1-DEE4AD6C
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "SLAsCAPCReqFunDetalle.php");
...
//Open Method @3-77FB7737
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
        "FROM mc_info_capc_cr_RF {SQL_Where} {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SLAsCAPCReqFunDetalle.html";
$BlockToParse = "main";
...
//Include events file @1-73FED549
include_once("./SLAsCAPCReqFunDetalle_events.php");

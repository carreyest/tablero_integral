<?php
//Include Common Files @1-594CFFAE
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "PPMCsCalificados.php");
...
//Class_Initialize Event @3-CCA6A3FA
    function clsGridGrid1($RelativePath, & $Parent)
    {
        ...
        $this->id_ppmc->Page = "CalificaPPMCCAPC.php";
        ...
        $this->CUMPL_REQ_FUNC = new clsControl(ccsLabel, "CUMPL_REQ_FUNC", "CUMPL_REQ_FUNC", ccsBoolean, $CCSLocales->GetFormatInfo("BooleanFormat"), CCGetRequestParam("CUMPL_REQ_FUNC", ccsGet, NULL), $this);
        ...
        $this->RETR_ENTREGABLE = new clsControl(ccsLabel, "RETR_ENTREGABLE", "RETR_ENTREGABLE", ccsBoolean, $CCSLocales->GetFormatInfo("BooleanFormat"), CCGetRequestParam("RETR_ENTREGABLE", ccsGet, NULL), $this);
        $this->COMPL_RUTA_CRITICA = new clsControl(ccsLabel, "COMPL_RUTA_CRITICA", "COMPL_RUTA_CRITICA", ccsBoolean, $CCSLocales->GetFormatInfo("BooleanFormat"), CCGetRequestParam("COMPL_RUTA_CRITICA", ccsGet, NULL), $this);
        $this->EST_PROY = new clsControl(ccsLabel, "EST_PROY", "EST_PROY", ccsBoolean, $CCSLocales->GetFormatInfo("BooleanFormat"), CCGetRequestParam("EST_PROY", ccsGet, NULL), $this);
        $this->DEF_FUG_AMB_PROD = new clsControl(ccsLabel, "DEF_FUG_AMB_PROD", "DEF_FUG_AMB_PROD", ccsBoolean, $CCSLocales->GetFormatInfo("BooleanFormat"), CCGetRequestParam("DEF_FUG_AMB_PROD", ccsGet, NULL), $this);
...
//DataSourceClass_Initialize Event @3-3FDC8025
    function clsGrid1DataSource(& $Parent)
    {
        ...
        $this->CUMPL_REQ_FUNC = new clsField("CUMPL_REQ_FUNC", ccsBoolean, $this->BooleanFormat);
        ...
        $this->COMPL_RUTA_CRITICA = new clsField("COMPL_RUTA_CRITICA", ccsBoolean, $this->BooleanFormat);
        
        $this->EST_PROY = new clsField("EST_PROY", ccsBoolean, $this->BooleanFormat);
        
        $this->DEF_FUG_AMB_PROD = new clsField("DEF_FUG_AMB_PROD", ccsBoolean, $this->BooleanFormat);
...
//Open Method @3-8D35B529
    function Open()
    {
        ...
        "and (anioreporte =" . $this->SQLValue($this->wp->GetDBValue("7"), ccsInteger) . "  or " . $this->SQLValue($this->wp->GetDBValue("7"), ccsInteger) . "=0)) cnt";
...
//Class_Initialize Event @56-E2753DE3
...
//CheckErrors Method @56-7A3A338C
...
//Operation Method @56-BAA954BC
    function Operation()
    {
        ...
        $Redirect = "PPMCsCalificados.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "PPMCsCalificados.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "PPMCsCalificados.html";
$BlockToParse = "main";
...
//Include events file @1-4AB3347E
include_once("./PPMCsCalificados_events.php");

...
WHERE mi.Id_incidente = '{Id_incidente}' " errorSummator="Error" allowCancel="False" recordDeleteConfirmation="False" buttonsType="button" wizardRecordKey="Id" encryptPasswordField="False" wizardUseInterVariables="False" pkIsAutoincrement="True" wizardCaption="Add/Edit Mc Info Incidentes " wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="False" recordDirection="Horizontal" templatePageRecord="C:\Program Files (x86)\CodeChargeStudio5//Templates//Record//Horizontal.ccp|ccsTemplate" recordAddTemplatePanel="False" PathID="mc_info_incidentes2">
		...
		<Record id="347" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="mc_incidentes_reasignacio" connection="cnDisenio" dataSource="mc_incidentes_reasignaciones" errorSummator="Error" allowCancel="True" recordDeleteConfirmation="True" buttonsType="button" wizardRecordKey="id" encryptPasswordField="False" wizardUseInterVariables="False" pkIsAutoincrement="True" wizardCaption="Agregar/Editar Mc Incidentes Reasignaciones " wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="False" recordDirection="Vertical" recordAddTemplatePanel="False" PathID="mc_incidentes_reasignacio">
			...
			<SQLParameters/>
			<JoinTables>
				<JoinTable id="503" tableName="mc_incidentes_reasignaciones"/>
			</JoinTables>
			<JoinLinks/>
			<Fields>
			...
			<USQLParameters/>
			<UConditions>
				<TableParameter id="485" conditionType="Parameter" useIsNull="False" field="id_incidente" dataType="Text" parameterType="URL" parameterSource="Id_incidente" searchConditionType="Equal" logicOperator="And" orderNumber="1"/>
			</UConditions>
			<UFormElements>
				<CustomParameter id="486" field="primera_fecha_asignacion" dataType="Date" parameterType="Control" parameterSource="primera_fecha_asignacion" format="dd/mm/yyyy HH:nn:ss" DBFormat="yyyy-mm-dd HH:nn:ss.S"/>
				<CustomParameter id="487" field="primera_fecha_encurso" dataType="Date" parameterType="Control" parameterSource="primera_fecha_encurso" format="dd/mm/yyyy HH:nn:ss" DBFormat="yyyy-mm-dd HH:nn:ss.S"/>
				<CustomParameter id="488" field="id_incidente" dataType="Text" parameterType="Control" parameterSource="H_id_incidente"/>
				<CustomParameter id="489" field="mes" dataType="Text" parameterType="Control" parameterSource="H_mes"/>
				<CustomParameter id="490" field="anio" dataType="Text" parameterType="Control" parameterSource="H_anio"/>
				<CustomParameter id="491" field="horas_invertidas" dataType="Float" parameterType="Control" parameterSource="H_horas_invertidas"/>
				<CustomParameter id="492" field="primera_fecha_nuevo" dataType="Date" parameterType="Control" parameterSource="primera_fecha_nuevo" format="dd/mm/yyyy HH:nn:ss" DBFormat="yyyy-mm-dd HH:nn:ss.S"/>
			</UFormElements>
			<DSPParameters/>
			<DSQLParameters/>
			<DConditions/>
		...
		<Record id="450" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="mc_incidentes_t_espera" connection="cnDisenio" dataSource="mc_incidentes_t_espera" errorSummator="Error" allowCancel="True" recordDeleteConfirmation="True" buttonsType="button" wizardRecordKey="id_incidente" encryptPasswordField="False" wizardUseInterVariables="False" pkIsAutoincrement="True" wizardCaption="Agregar tiempo de espera" wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="True" recordDirection="Vertical" recordAddTemplatePanel="False" PathID="mc_incidentes_t_espera">
			<Components>
				<Button id="452" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" wizardCaption="Agregar" PathID="mc_incidentes_t_esperaButton_Insert">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="453" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Update" operation="Update" wizardCaption="Enviar" PathID="mc_incidentes_t_esperaButton_Update">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="454" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Cancel" operation="Cancel" wizardCaption="Cancelar" PathID="mc_incidentes_t_esperaButton_Cancel">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Label id="456" fieldSourceType="DBColumn" dataType="Integer" html="False" generateSpan="False" name="mes" fieldSource="mes" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Mes" wizardAddNbsp="True" PathID="mc_incidentes_t_esperames" defaultValue="CCGetParam(&quot;s_mes_param&quot;)">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="457" fieldSourceType="DBColumn" dataType="Integer" html="False" generateSpan="False" name="anio" fieldSource="anio" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Anio" wizardAddNbsp="True" PathID="mc_incidentes_t_esperaanio" defaultValue="CCGetParam(&quot;s_anio_param&quot;)">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="462" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="id_incidente" PathID="mc_incidentes_t_esperaid_incidente" fieldSource="id_incidente" defaultValue="CCGetParam(&quot;Id_incidente&quot;)">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="463" fieldSourceType="DBColumn" dataType="Text" name="H_id_incidente" PathID="mc_incidentes_t_esperaH_id_incidente" fieldSource="id_incidente" defaultValue="CCGetParam(&quot;Id_incidente&quot;)">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="464" fieldSourceType="DBColumn" dataType="Text" name="H_mes" PathID="mc_incidentes_t_esperaH_mes" fieldSource="mes" defaultValue="CCGetParam(&quot;s_mes_param&quot;)">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="465" fieldSourceType="DBColumn" dataType="Text" name="H_anio" PathID="mc_incidentes_t_esperaH_anio" fieldSource="anio" defaultValue="CCGetParam(&quot;s_anio_param&quot;)">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<TextBox id="467" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DHoraEsperaS" PathID="mc_incidentes_t_esperaDHoraEsperaS" features="(assigned)">
					<Components/>
					<Events>
						...
						<Event name="BeforeShow" type="Server">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="501"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					<Features>
						<JNumericUpDown id="468" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="23" name="NumericUpDown1" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<TextBox id="469" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DMinEsperaS" PathID="mc_incidentes_t_esperaDMinEsperaS" features="(assigned)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
					...
					<Attributes/>
					<Features>
						<JNumericUpDown id="470" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="59" name="NumericUpDown2" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<TextBox id="471" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DSegEsperaS" PathID="mc_incidentes_t_esperaDSegEsperaS" features="(assigned)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="481"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					<Features>
						<JNumericUpDown id="472" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="59" name="NumericUpDown3" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<Hidden id="459" fieldSourceType="DBColumn" dataType="Float" name="horas_t_solucion" fieldSource="horas_t_solucion" wizardIsPassword="False" wizardUseTemplateBlock="False" visible="Yes" wizardCaption="Horas T Solucion" caption="Horas T Solucion" required="False" unique="False" PathID="mc_incidentes_t_esperahoras_t_solucion" DBFormat="#.000">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<TextBox id="473" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DHoraEsperaA" PathID="mc_incidentes_t_esperaDHoraEsperaA" features="(assigned)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="482"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					<Features>
						<JNumericUpDown id="474" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="23" name="NumericUpDown4" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<TextBox id="475" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DMinEsperaA" PathID="mc_incidentes_t_esperaDMinEsperaA" features="(assigned)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="483"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					<Features>
						<JNumericUpDown id="476" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="59" name="NumericUpDown5" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<TextBox id="477" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="DSegEsperaA" PathID="mc_incidentes_t_esperaDSegEsperaA" features="(assigned)">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="484"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
					<Features>
						<JNumericUpDown id="478" enabled="True" step="1" page="1" type="Numeric" minValue="0" maxValue="59" name="NumericUpDown6" category="jQuery">
							<Components/>
							<Events/>
							<ControlPoints/>
							<Features/>
				...
				<Hidden id="458" fieldSourceType="DBColumn" dataType="Float" name="horas_t_atencion" fieldSource="horas_t_atencion" wizardIsPassword="False" wizardUseTemplateBlock="False" visible="Yes" wizardCaption="Horas T Atencion" caption="Horas T Atencion" required="False" unique="False" PathID="mc_incidentes_t_esperahoras_t_atencion" DBFormat="#.000">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<ListBox id="507" visible="Yes" fieldSourceType="DBColumn" sourceType="ListOfValues" dataType="Text" returnValueType="Number" name="operacionTsolucion" wizardEmptyCaption="Seleccionar Valor" PathID="mc_incidentes_t_esperaoperacionTsolucion" dataSource="1;Sumar;-1;Restar" defaultValue="1" required="True" caption="Operacion_T_Solucion">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
				...
				<ListBox id="508" visible="Yes" fieldSourceType="DBColumn" sourceType="ListOfValues" dataType="Text" returnValueType="Number" name="operacionTatencion" wizardEmptyCaption="Seleccionar Valor" PathID="mc_incidentes_t_esperaoperacionTatencion" caption="Operacion_T_Atencion" dataSource="1;Sumar;-1;Restar" required="True" defaultValue="1">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
			...
			<SQLParameters/>
			<JoinTables>
				<JoinTable id="504" posHeight="152" posLeft="10" posTop="10" posWidth="132" tableName="mc_incidentes_t_espera"/>
			</JoinTables>
			<JoinLinks/>
			<Fields>
				<Field id="506" fieldName="*"/>
			</Fields>
			<PKFields/>
			<ISPParameters/>
			<ISQLParameters/>
			...
			<USQLParameters/>
			<UConditions>
				<TableParameter id="493" conditionType="Parameter" useIsNull="False" field="id_incidente" dataType="Text" parameterType="URL" parameterSource="id_incidente" searchConditionType="Equal" logicOperator="And" orderNumber="1"/>
			</UConditions>
			<UFormElements>
				<CustomParameter id="494" field="id_incidente" dataType="Text" parameterType="Control" parameterSource="H_id_incidente"/>
				<CustomParameter id="495" field="mes" dataType="Text" parameterType="Control" parameterSource="H_mes"/>
				<CustomParameter id="496" field="anio" dataType="Text" parameterType="Control" parameterSource="H_anio"/>
				<CustomParameter id="497" field="horas_t_solucion" dataType="Integer" parameterType="Control" parameterSource="horas_t_solucion"/>
				<CustomParameter id="498" field="horas_t_atencion" dataType="Integer" parameterType="Control" parameterSource="horas_t_atencion"/>
			</UFormElements>
			<DSPParameters/>
			<DSQLParameters/>
			<DConditions/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="IncidenteDetalle4_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="IncidenteDetalle4.php" forShow="True" url="IncidenteDetalle4.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>

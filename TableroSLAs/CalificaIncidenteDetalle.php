<?php
//Include Common Files @1-07CF33CE
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "CalificaIncidenteDetalle.php");
...
//Class_Initialize Event @143-DA52A887
    function clsRecordmc_calificacion_incidente($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Cumple_DISP_SOPORTE = new clsControl(ccsListBox, "Cumple_DISP_SOPORTE", $CCSLocales->GetText("Cumple_DISP_SOPORTE"), ccsInteger, "", CCGetRequestParam("Cumple_DISP_SOPORTE", $Method, NULL), $this);
            $this->Cumple_DISP_SOPORTE->DSType = dsListOfValues;
            $this->Cumple_DISP_SOPORTE->Values = array(array("", "No Aplica"), array("1", "Cumplio"), array("0", "No Cumplio"));
...
//CheckErrors Method @143-71F3C87D
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @143-8937F54D
    function Operation()
    {
        ...
        $Redirect = "CalificaIncidenteDetalle.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//DataSource Variables @143-8CA798CC
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @143-D2E6599C
...
class clsRecordmc_c_aplicacion { //mc_c_aplicacion Class @234-D758B9FC
...
//Class_Initialize Event @234-3A3785E7
...
//Initialize Method @234-3E703885
    function Initialize()
    {
...
//CheckErrors Method @234-555AB3CA
    function CheckErrors()
    {
        $errors = false;
...
} //End mc_c_aplicacion Class @234-FCB6E20C

class clsmc_c_aplicacionDataSource extends clsDBcnDisenio {  //mc_c_aplicacionDataSource Class @234-556B5F31

//DataSource Variables @234-19864DAF
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @234-60AC0D33
...
} //End mc_c_aplicacionDataSource Class @234-FCB6E20C

//Include Page implementation @282-3DD2EFDC
include_once(RelativePath . "/Header.php");
//End Include Page implementation

//Initialize Page @1-F7942863
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "CalificaIncidenteDetalle.html";
$BlockToParse = "main";
...
//Include events file @1-49C71A0C
include_once("./CalificaIncidenteDetalle_events.php");
...
//Go to destination page @1-4ED9A4B4
if($Redirect)
{

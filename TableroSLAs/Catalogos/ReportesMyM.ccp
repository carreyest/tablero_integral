...
<Action actionName="Custom Code" actionCategory="General" id="56"/>
			...
			<ISQLParameters/>
			<IFormElements>
<CustomParameter id="51" field="Nombre" dataType="Text" parameterType="Control" parameterSource="Nombre"/>
<CustomParameter id="52" field="Descripcion" dataType="Text" parameterType="Control" parameterSource="Descripcion"/>
<CustomParameter id="53" field="NombreRDL" dataType="Text" parameterType="Control" parameterSource="NombreRDL"/>
<CustomParameter id="54" field="Grupo" dataType="Text" parameterType="Control" parameterSource="grupo"/>
<CustomParameter id="55" field="activo" dataType="Integer" parameterType="Control" parameterSource="CheckBox1"/>
</IFormElements>
			<USPParameters/>
			<USQLParameters/>
			<UConditions/>
